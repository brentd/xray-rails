if defined?(Rails) && Rails.env.development?
  ...
  module Xray
    ...
    # Matches strings that look like the type of javascript constructors we're
    # interested in knowing the file location of.
    #
    # Example matches:
    #   MyView = Backbone.View.extend({ ...
    #   Foo.MyView = Backbone.View.extend({ ...
    #
    # Matches coffeescript-generated constructors that look like this:
